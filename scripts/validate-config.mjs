...
const errors = [];
for (const section of ['minimum_agents_for_auto_routing', 'activation:', 'risk:', 'roles:', 'ownership:', 'approval:', 'cost:']) if (!text.includes(section)) errors.push('missing section: ' + section);
